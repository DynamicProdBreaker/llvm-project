...
; RUN: llc -global-isel=1 -mtriple=amdgcn -mcpu=tonga -mattr=-flat-for-global -global-isel-abort=2 < %s | FileCheck -enable-var-scope -check-prefixes=GFX8,GFX8-GISEL %s
