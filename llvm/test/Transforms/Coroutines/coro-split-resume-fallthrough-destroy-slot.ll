...
; CHECK:         %[[RESUME_DESTROY_ADDR:.+]] = getelementptr inbounds i8, ptr %hdl, i64 8
; CHECK-NEXT:    %[[RESUME_DESTROY:.+]] = load ptr, ptr %[[RESUME_DESTROY_ADDR]]
; CHECK:         call void @print(i32 1)
; CHECK-NOT:     call void @free(
; CHECK:         tail call void %[[RESUME_DESTROY]](ptr %hdl)
; CHECK-NEXT:    ret void
